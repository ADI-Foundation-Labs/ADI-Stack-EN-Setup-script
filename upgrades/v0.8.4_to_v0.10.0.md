...
Pull the latest changes from the repository to ensure you have the most recent version of the setup script:

```bash
git pull origin main
```

Verify the script is updated:

```bash
git status
```

You should see that your branch is up to date with 'origin/main'.
...
### Step 3: Remove Existing Chain Data
...
### Step 4: Wait for Sequencer Upgrade
...
**Do not proceed to Step 5 until you receive explicit confirmation.**

### Step 5: Pull Latest External Node Image

Pull the updated v0.10.0-b2 container image:
...
This will download:
```
harbor.sre.ideasoft.io/adi-chain/external-node:latest (904cb36133a8)
```
...
### Step 6: Download Shared Proofs (Optional but Recommended)
...
### Step 7: Start the External Node
